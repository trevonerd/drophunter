...
export function updateStateFromSnapshot(state: ServiceWorkerState, snapshot: DropsSnapshot) {
  ...
  // normalizeQueueSelection stays in service-worker.ts — called separately
