...
- Variants: fresh (sync row omitted), syncing, waiting/retry-scheduled, stale, failed, and empty; signed-out uses the dedicated priority TwitchSessionGate before AutomationSummary and suppresses SessionSummary and Campaigns. Planned reward variants remain pending, active, claimable, claimed, subscription-gated, and unverifiable Twitch-native.
